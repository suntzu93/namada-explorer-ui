        ...
        >
          ...
          <TableCell align="left">
            <Link
              target="_blank"
              underline="hover"
              href={Utils.getDomain() + "?transaction=" + row.hash}
          ...
          <TableCell align="left">{row.fee_amount_per_gas_unit == null ? "0" : row.fee_amount_per_gas_unit}</TableCell>
          <TableCell align="left">
            {row.tx_type}
          </TableCell>
          <TableCell align="left">
            {Data.formatTimeToText(Data.convertTimeStringToMilisecond(row.header_time))}
          </TableCell>
        </TableRow>
      </React.Fragment>
    );
